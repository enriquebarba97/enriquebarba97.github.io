---
title: "Green AI by Default: Energy Reduction Techniques for LLMs in SE"
authors:
    - Enrique Barba Roque
collection: publications
category: conferences
permalink: /publication/2026-04-12-green-by-default
excerpt: 'Extended abstract for Green AI research, identifying open challenges and mapping out a research plan to improve metrics and optimization methods for LLMs.'
date: 2026-02-27
venue: 'International Conference on Software Engineering - Doctoral Symposium, Rio de Janeiro, Brazil'
paperurl: 'https://ebarba.com/files/DS_Green_AI_by_Default.pdf'
# citation: ''
abstract: "Large Language Models (LLMs) are increasingly being applied to Software Engineering (SE) tasks, showing high accuracy in various problems. However, their high computational demands and energy consumption raise sustainability concerns and hinder their use on consumer hardware and resource-constrained platforms.
...
[Pre-print](https://ebarba.com/files/DS_Green_AI_by_Default.pdf)
